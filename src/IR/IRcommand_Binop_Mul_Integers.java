...
public class IRcommand_Binop_Mul_Integers extends IRcommand
{
	...
	public IRcommand_Binop_Mul_Integers(TEMP dst_register, TEMP left_operand, TEMP right_operand)
	{
	...
	public void MIPSme()
	{
		MIPSGenerator.getInstance().mul(dst_register, left_operand, right_operand);
