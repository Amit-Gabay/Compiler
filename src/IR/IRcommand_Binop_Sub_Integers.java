...
public class IRcommand_Binop_Sub_Integers extends IRcommand
{
    ...
    public IRcommand_Binop_Sub_Integers(TEMP dst_register, TEMP left_operand, TEMP right_operand)
    {
    ...
    public void MIPSme()
    {
        MIPSGenerator.getInstance().sub(dst_register, left_operand, right_operand);
