...
public class IRcommand_Binop_Div_Integers extends IRcommand
{
    ...
    public IRcommand_Binop_Div_Integers(TEMP dst_register ,TEMP left_operand, TEMP right_operand)
    {
    ...
    public void MIPSme()
    {
        MIPSGenerator.getInstance().check_division_by_zero(right_operand);
        MIPSGenerator.getInstance().div(dst_register, left_operand, right_operand);
